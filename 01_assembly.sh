...
do
    ...
    cat ${path_name}/match.tsv  | awk '{ if ($3 >= 80 && $4 >= 50) print $1 }' | sort | uniq > ${path_name}/match_read.txt
    ...
    if [[ $read_count -gt 30000 ]]; then
        ...
        rasusa aln --coverage 500 ${path_name}/sel_filter.bam | samtools sort -o  ${path_name}/downsample.bam
    ...
    ### Amino acid sequence
    ref_name=$(cat ${path_name}/match.tsv |  awk '{ if ($3 >= 80 && $4 >= 50) print $2 }' | sort | uniq -c | \
